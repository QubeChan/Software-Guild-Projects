...
public class RockPaperScissors {
    ...
    // Prompts the user for his RPS option and will trim and change all letters to lowercase
    // while handling cases for whether or not the input is a valid choice, if not run the method again
    ...
    public static String playRPS() {
        int userChoice,
                compChoice = new Random().nextInt(3) + 1;
        String userInput;
        userInput = promptUser().trim().toLowerCase();
    ...
    public static void displayWinner(int numRound, int winCount, int loseCount, int tieCount) {
