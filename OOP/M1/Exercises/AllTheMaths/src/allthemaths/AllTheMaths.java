...
public class AllTheMaths {
    ...
    public static void main(String[] args) {
        ...
        // If you remove all the decimal places and divide they become an int but if you remove only one of the two items with decimals the other item will automatically cast to a decimal number
